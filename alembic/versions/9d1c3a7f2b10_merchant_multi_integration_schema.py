...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("api_key", sa.String(96), nullable=False),
        sa.Column("webhook_url", sa.String(512), nullable=True),
        sa.Column("webhook_secret", nexolu_payments_core.core.security.crypto.EncryptedString(255), nullable=False),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("private_key", nexolu_payments_core.core.security.crypto.EncryptedString(255), nullable=False),
        sa.Column("integrity_secret", nexolu_payments_core.core.security.crypto.EncryptedString(255), nullable=False),
        sa.Column("events_secret", nexolu_payments_core.core.security.crypto.EncryptedString(255), nullable=False),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["merchant_id"], ["merchants.id"]),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("merchant_id", "provider_slug", "environment", name="uq_credential_merchant_provider_env"),
    )
