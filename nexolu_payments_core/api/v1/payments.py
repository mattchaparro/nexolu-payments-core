...
@router.post("/intents/{reference}/charge", summary="Charge a payment intent")
...
@router.get("/pse/financial-institutions", summary="PSE financial institutions")
...
@router.post("/payment-sources", status_code=201, summary="Create a reusable payment source")
...
@router.put("/payment-sources/{payment_source_id}/void", summary="Void a payment source")
...
@router.get("/transactions/{reference}", summary="Get transaction status")
